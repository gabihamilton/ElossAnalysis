...
const TString f_location = "/work/smoran/chargedPions/"; // The location of data and simulation files with ntuples inside
const TString fd_ext = ".root";
const TString fs_ext = ".root";
...
int main(int argc, char **argv)
{
  ...
  TCut cuts_simulD = Q2_cut_S&&Nu_cut_S&&Phi_cut_S&&Pt2_cut_S; //Target cuts removed
  ...
  data->SetBranchStatus("Pt2",1); //era Pt só
  ...
  TFile *plots = new TFile(Form("output/Smoran1Dfout_"+Nuclei_Type+"_%dnubin%d.root", N_Nu, Nu_bin),"RECREATE");
  //cout << "OK" << endl;
