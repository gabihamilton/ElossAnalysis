...
int main(int argc, char *argv[]){
	...
	TFile *fout = new TFile(Form("KS/final2D_"+Nuclei_Type+"_%dnubins_cheb%d_Ebins%d.root", N_Nu, n, nbins), "RECREATE");
...
*/
		...
		canvas->BuildLegend();
		canvas->SaveAs(Form("KS/final2D_Prob_"+Nuclei_Type+"_%dnubin%d_%dentries_cheb%d_Ebins%d.pdf", N_Nu, Nu_bin, nentries, n, nbins));
		canvas->SaveAs(Form("KS/final2D_Prob_"+Nuclei_Type+"_%dnubin%d_%dentries_cheb%d_Ebins%d.png", N_Nu, Nu_bin, nentries, n, nbins));
...
*/
		...
		D->Draw("Csame");
		//C2->BuildLegend();
		C2->SaveAs(Form("KS/final2D_KSbMatch_"+Nuclei_Type+"_%dnubin%d_%dentries_cheb%d_Ebins%d.pdf", N_Nu, Nu_bin, nentries, n, nbins));
		C2->SaveAs(Form("KS/final2D_KSbMatch_"+Nuclei_Type+"_%dnubin%d_%dentries_cheb%d_Ebins%d.png", N_Nu, Nu_bin, nentries, n, nbins));
/*
...
*/
		...
		DW->Draw("Csame");
		//C4->BuildLegend();
		C4->SaveAs(Form("KS/final2D_WKSbMatch_"+Nuclei_Type+"_%dnubin%d_%dentries_cheb%d_Ebins%d.pdf", N_Nu, Nu_bin, nentries, n, nbins));
		C4->SaveAs(Form("KS/final2D_WKSbMatch_"+Nuclei_Type+"_%dnubin%d_%dentries_cheb%d_Ebins%d.png", N_Nu, Nu_bin, nentries, n, nbins));
...
/*
	    ...
	    sigma=0.;
*/
	    double mean1=0., sigma1=0.;
	    gElossWKSb->SetPoint(Nu_bin, (Nu_min+Nu_max)/2, i_WKSb);
	    get_values(gpWKSb, mean1, sigma1);
	    gElossWKSb->SetPointError(Nu_bin, 0, sigma1);
	    mean1=0.;
	    sigma1=0.;
	    cout << "END OF NU " << Nu_bin << endl;
...
*/
	...
	canvas->BuildLegend();
	canvas->SaveAs(Form("KS/final2D_Eloss_"+Nuclei_Type+"_%dnubins_%dentries_cheb%d_Ebins%d.pdf", N_Nu, nentries, n, nbins));
	canvas->SaveAs(Form("KS/final2D_Eloss_"+Nuclei_Type+"_%dnubins_%dentries_cheb%d_Ebins%d.png", N_Nu, nentries, n, nbins));
	//canvas->Write();
