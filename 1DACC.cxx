...
int main(int argc, char **argv)
{
  ...
  #ifdef SMORAN
    TFile *plots = new TFile(Form("acc/SM1Dfout_"+Nuclei_Type+"_%dnubin%d_Ebins%d_step%f.root", N_Nu, Nu_bin, nbins, step_E*1000),"RECREATE");
  #else
    TFile *plots = new TFile(Form("acc/HH1Dfout_"+Nuclei_Type+"_%dnubin%d_Ebins%d_step%f.root", N_Nu, Nu_bin, nbins, step_E*1000),"RECREATE");
  #endif
